...
import com.mohitchaudhary.cryptonewspaper.api.ApiClient;
import com.mohitchaudhary.cryptonewspaper.api.ApiInterface;
import com.mohitchaudhary.cryptonewspaper.models.Article;
import com.mohitchaudhary.cryptonewspaper.models.News;
...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        interstitialAd = new InterstitialAd(this, "2541127589455617_2541588629409513");
...
/*
    ...
    public void loadJSON(final String keyword){
        ...
        if (keyword.length() > 0) {
            ...
            call = apiInterface.getNewsSearch("cryptocurrency", language, "publishedAt", API_KEY);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_About){
            ...
            desc.setText("CryptoNewspaper App\nVersion "+BuildConfig.VERSION_NAME+"\nDeveloped by Code Apps Inc." +
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.nav_home:
                ...
                break;
            case R.id.nav_home2:
                onLoadingSwipeRefresh("bitcoin");
                break;
            case R.id.nav_home3:
                onLoadingSwipeRefresh("ethereum");
                break;
            case R.id.coindesk:
                onLoadingSwipeRefresh("coindesk.com");
                break;
            case R.id.cointelegraph:
                onLoadingSwipeRefresh("cointelegraph.com");
                break;
            case R.id.newsBTC:
                onLoadingSwipeRefresh("newsbtc.com");
                break;
            case R.id.bitcoinist:
                onLoadingSwipeRefresh("bitcoinist.com");
                break;
            case R.id.nav_rate:
